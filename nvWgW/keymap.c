...
#define DUAL_FUNC_15 LT(12, KC_I)
#define DUAL_FUNC_16 LT(4, KC_4)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    TD(DANCE_0),    KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_DELETE,                                      TG(1),          KC_Y,           KC_U,           KC_I,           KC_O,           DUAL_FUNC_5,    KC_BSPC,
    ALL_T(KC_CAPS), KC_A,           KC_S,           KC_D,           DUAL_FUNC_0,    KC_G,           LALT(LGUI(KC_LEFT_CTRL)),                                                                DUAL_FUNC_6,    KC_H,           KC_J,           KC_K,           KC_L,           LT(2, KC_SCLN), MT(MOD_RSFT, KC_ENTER),
    ...
    TD(DANCE_1),    CW_TOGG,        OSL(3),         KC_LEFT,        KC_RIGHT,       LGUI(LSFT(KC_G)),                                                                                                TD(DANCE_3),    KC_UP,          KC_DOWN,        KC_LBRC,        KC_RBRC,        KC_RIGHT_CTRL,
    KC_LEFT_GUI,    KC_LEFT_ALT,    LGUI(LCTL(KC_0)),                KC_HYPR,        KC_TAB,         MT(MOD_LALT, KC_SPACE)
  ),
  [1] = LAYOUT_moonlander(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         AC_TOGG,         
    ...
    KC_TRANSPARENT, KC_COMMA,       HSV_0_245_245,  HSV_74_255_206, HSV_152_255_255,RGB_MODE_FORWARD,                                                                                                KC_TRANSPARENT, KC_KP_DOT,      KC_KP_0,        KC_EQUAL,       KC_KP_ASTERISK, KC_KP_ENTER,    
  ...
  [2] = LAYOUT_moonlander(
    ...
    MU_NEXT,        KC_MEH,         KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, TD(DANCE_4),    TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    KC_TRANSPARENT, KC_MEDIA_PLAY_PAUSE,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,     KC_MS_BTN2,     KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, TD(DANCE_8),    TD(DANCE_9),    KC_AUDIO_MUTE,  KC_TRANSPARENT, KC_MEDIA_NEXT_TRACK,
    DUAL_FUNC_7,    DUAL_FUNC_8,    KC_TRANSPARENT,                 KC_TRANSPARENT, KC_WWW_BACK,    KC_WWW_FORWARD
  ),
  [3] = LAYOUT_moonlander(
    KC_NO,          RALT(RCTL(RSFT(KC_KP_1))),RALT(RCTL(RSFT(KC_KP_2))),DUAL_FUNC_9,    RALT(RCTL(RSFT(KC_KP_4))),KC_NO,          KC_NO,                                          RALT(RCTL(RSFT(KC_KP_6))),RALT(RCTL(RSFT(KC_KP_6))),RALT(RCTL(RSFT(KC_KP_7))),KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_TRANSPARENT, TD(DANCE_10),   KC_NO,          LGUI(KC_E),     LGUI(LSFT(KC_R)),TD(DANCE_11),   KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          LCTL(KC_I),     KC_NO,          KC_NO,          KC_NO,
    KC_NO,          DUAL_FUNC_10,   KC_NO,          KC_NO,          LGUI(LSFT(KC_F)),KC_NO,          KC_TRANSPARENT,                                                                 KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT, KC_NO,          
    KC_NO,          KC_TRANSPARENT, KC_NO,          LGUI(KC_1),     LGUI(KC_9),     KC_NO,                                                                                                          LGUI(LSFT(KC_R)),KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    LGUI(LSFT(KC_LBRC)),KC_NO,          RGUI(RSFT(KC_RBRC)),                KC_NO,          LGUI(KC_LBRC),  RGUI(KC_RBRC)
  ),
  [4] = LAYOUT_moonlander(
    KC_TRANSPARENT, TD(DANCE_12),   TD(DANCE_13),   TD(DANCE_14),   TD(DANCE_15),   TD(DANCE_16),   KC_TRANSPARENT,                                 LGUI(LSFT(KC_B)),TD(DANCE_17),   TD(DANCE_18),   KC_TRANSPARENT, LALT(LSFT(KC_EQUAL)),LALT(LSFT(KC_MINUS)),LGUI(LSFT(KC_B)),
    KC_TRANSPARENT, KC_TRANSPARENT, LGUI(LCTL(KC_W)),KC_F,           LALT(LSFT(KC_R)),LALT(LSFT(KC_T)),KC_TRANSPARENT,                                 TD(DANCE_19),   LALT(LSFT(KC_H)),LALT(LSFT(KC_J)),LALT(LSFT(KC_K)),LALT(LSFT(KC_L)),KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, LGUI(LCTL(KC_A)),LGUI(LCTL(KC_S)),LGUI(LCTL(KC_D)),LGUI(LSFT(KC_F)),KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, LALT(KC_H),     DUAL_FUNC_14,   DUAL_FUNC_15,   LALT(KC_L),     KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, LGUI(LCTL(KC_Z)),DUAL_FUNC_11,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 LALT(LGUI(KC_H)),DUAL_FUNC_16,   LALT(LGUI(KC_K)),LALT(LGUI(KC_L)),LALT(LSFT(KC_M)),KC_LEFT_GUI,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_12,   DUAL_FUNC_13,   LGUI(KC_9),                                                                                                     LGUI(LSFT(KC_R)),TD(DANCE_20),   TD(DANCE_21),   TD(DANCE_22),   TD(DANCE_23),   LALT(KC_SLASH),
...
void dance_22_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[22].step) {
        case SINGLE_TAP: register_code16(LALT(KC_COMMA)); break;
        case DOUBLE_TAP: register_code16(LALT(LSFT(KC_MINUS))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LALT(KC_COMMA)); register_code16(LALT(KC_COMMA));
    }
}
...
void dance_22_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[22].step) {
        case SINGLE_TAP: unregister_code16(LALT(KC_COMMA)); break;
        case DOUBLE_TAP: unregister_code16(LALT(LSFT(KC_MINUS))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LALT(KC_COMMA)); break;
    }
...
void dance_23_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[23].step) {
        case SINGLE_TAP: register_code16(LALT(KC_DOT)); break;
        case DOUBLE_TAP: register_code16(LALT(LSFT(KC_EQUAL))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LALT(KC_DOT)); register_code16(LALT(KC_DOT));
    }
}
...
void dance_23_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[23].step) {
        case SINGLE_TAP: unregister_code16(LALT(KC_DOT)); break;
        case DOUBLE_TAP: unregister_code16(LALT(LSFT(KC_EQUAL))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LALT(KC_DOT)); break;
    }
...
static void process_autocorrect_for_custom_keycode(uint16_t keycode, keyrecord_t *record) {
  ...
  case QK_MODS ... QK_MODS_MAX:
    ...
    case DUAL_FUNC_0:
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          process_autocorrect_for_custom_keycode(KC_F, record);
    ...
    case DUAL_FUNC_1:
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          process_autocorrect_for_custom_keycode(KC_Z, record);
    ...
    case DUAL_FUNC_2:
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          process_autocorrect_for_custom_keycode(KC_X, record);
    ...
    case DUAL_FUNC_3:
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          process_autocorrect_for_custom_keycode(KC_C, record);
    ...
    case DUAL_FUNC_4:
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          process_autocorrect_for_custom_keycode(KC_V, record);
    ...
    case DUAL_FUNC_5:
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          process_autocorrect_for_custom_keycode(KC_P, record);
